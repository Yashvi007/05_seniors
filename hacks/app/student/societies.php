...
<div class="wrapper">
    ...
    <div id="content" style="padding: 0px 10px !important;">
            ...
            <div class="row">
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active" aria-current="page">Add Societies Event</li>
                    </ol>
                </nav>
            </div>
        </div>
        ...
        <form method="POST" enctype="multipart/form-data" action="php/sevents.php">
            <div class="form-group">
                <label>Enter Society Event Name</label>
