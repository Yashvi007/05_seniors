...
$depeven_id = $_POST['keyname'];
$query = "SELECT * from event_faculty WHERE id='$depeven_id'";
...
while (($row = mysqli_fetch_array($res))) {
    ...
    $e_id = $row['id'];
    $ename = $row['ename'];
    $qq = "SELECT * from reg_dept where event_id ='$e_id' AND stud_id='$stud_id'";
...
<a href='php/depreg.php?id=$e_id' class='btn btn-primary'>Participate</a>
</div>
