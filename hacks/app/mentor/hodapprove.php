...
<div class="wrapper">
            ...
            <div class="row">
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active" aria-current="page">Approve Faculty Event</li>
                    </ol>
                </nav>
            </div>
        </div>
    ...
    <style type="text/css">
        ...
        <?php
        $n="NULL";
        $query = "SELECT * from event_faculty where department='$dep' and approved_by is NULL and arranged_by !='$m'";
...
<tr><td colspan=5>No Events to be Approved Yet</td></tr>
        ...
        while ($row = mysqli_fetch_array($res)) {
            ...
            $arr=$row['arranged_by'];
            $date=$row['edate'];
            $qw="SELECT fname,lname from faculty where eid='$arr'";
        ...
        <td><a href='php/approve.php?id=" . $id . "&app=" . $m . "'>
