...
<div class="wrapper">
            ...
            <div class="row">
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active" aria-current="page">Approve Student Body Event</li>
                    </ol>
                </nav>
            </div>
        </div>
    ...
    <style type="text/css">
        ...
        $query = "SELECT * from event_sbodies where sbid = '$sbid' and faculty_approved is NULL";
...
<tr><td colspan=5>No Events to be Approved Yet</td></tr>
        ...
        <td><a href='php/approvesb.php?id=" . $id . "&app=" . $m . "&sbid=".$sbid."'>
