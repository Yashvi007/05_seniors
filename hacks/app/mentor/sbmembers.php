...
<div class="wrapper">
    ...
    <div id="content" style="padding: 0px 10px !important;">
        ...
        <form method="POST" enctype="multipart/form-data" action="php/addmembers.php">
        	<div class="form-group">
                <input type="hidden" name="sbid" class="form-control" value = '<?php echo $sbid; ?>'>
                <br>
            </div>
            <div class="form-group">
                <label>Enter General Secretary ID</label>
                <input type="text" name="gsid" class="form-control">
                <br>
            </div>

            <div class="form-group">
                <label>Enter Senior Deputy ID</label>
                <input type="text" name="sdid" class="form-control">
                <br>
            </div>

            <div class="form-group">
                <label>Enter Junior Deputy ID</label>
                <input type="text" name="jdid" class="form-control">
                <br>
            </div>
